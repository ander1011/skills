...
export default function FloatingCard({ children, className = "", delay = 0, bgImage }: FloatingCardProps) {
  return (
    <motion.div
    ...
    >
      ...
      {/* Top edge glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-2/3 h-px bg-gradient-to-r from-transparent via-[#8b5cf6]/30 to-transparent z-10" />
